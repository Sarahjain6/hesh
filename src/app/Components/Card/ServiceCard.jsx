...
const ServiceCard = ({subtitle,title,content,list1,list2,btnname,btnurl,img1,img2,img3,img4}) => {
    return (
        ...
        <div className="row">
          <div className="col-lg-5">
            <div className="heading2">
              ...
              <p>{content}</p>
              <ul className="list">
                <li><span className="check"><i className="bi bi-check-lg"></i></span> {list1}</li>
                <li><span className="check"><i className="bi bi-check-lg"></i></span> {list2}</li>
              </ul>
