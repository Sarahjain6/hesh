            ...
            <div className="col-lg-6 m-auto text-center">
              <div className="heading3">
                ...
                <Image src="/assets/img/logo/main-span3.svg" alt="img" width={20} height={20}   />
                  How It works</span></p>
                <h2 className="text-anime-style-3">  Of SEOMAX</h2>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="" data-aos="fade-right" data-aos-duration="700">
                <div className="work-box">
                  ...
                  <div className="heading1">
                    <h4><a href="case-details.html">Comprehensive Website Audit</a></h4>
              ...
              <div className="" data-aos="fade-right" data-aos-duration="1200">
                <div className="work-box">
                  ...
                  <div className="heading1">
                    <h4><a href="case-details.html">Continuous Optimization</a></h4>
                    <div className="space16"></div>
                    <p>We begin with a detailed consultation your market business goals, target audience, marketing efforts. </p>
                  </div>
                </div>
            ...
            <div className="col-lg-6">
              <div className="work-images">
                ...
                <Image src="/assets/img/work/work3-img.png" alt="img" width={570} height={371}   />
                </div>
              </div>
            </div>
          </div>
